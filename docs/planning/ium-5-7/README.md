# IuM 5–7: Lebensweltbezug, externe Angebote und optionale Hardware

Stand: 13.09.2026. Dieser Einstieg dokumentiert die jüngsten Nutzerentscheidungen und den zugehörigen Konzeptvorschlag. Er ergänzt die bestehenden V2-Verträge. Die Fachkonzepte stehen hier als portable Lesefassungen; sie benötigen zum Verständnis keinen Zugang zum lokalen Vault.
...
## Anschluss an die V2-Grundlagen

- [Roadmap Klasse 5](../../../roadmap/v2/grades/grade-5/roadmap.json)
- [Roadmap Klasse 6](../../../roadmap/v2/grades/grade-6/roadmap.json)
- [Roadmap Klasse 7](../../../roadmap/v2/grades/grade-7/roadmap.json) und [Progression](../../../roadmap/v2/grades/grade-7/progression.json)
- [Lernarchitektur](../../../roadmap/v2/foundations/learning-experience/learning-architecture.md)
- [Materialgestaltung](../../../roadmap/v2/foundations/learning-experience/material-experience-guide.md)
- [Lehrkraftsteuerung](../../../roadmap/v2/foundations/learning-experience/teacher-orchestration.md)

Die Zuordnung verschiebt keine Kompetenzanforderungen oder Zeitbudgets. G7-M06 und G7-M07 bleiben curriculare Erweiterungen mit zusätzlichem Kapazitätsbedarf. Flexmodule tragen keine exklusiven Pflichtkompetenzen. Die Versionswahl für Fakefinder bedeutet insbesondere nicht, die normale Version ungeprüft als Kids-Ersatz nach Klasse 5 zu verschieben.
...
Für Hardwarevarianten muss die individuelle informatische Leistung sichtbar bleiben. Eine funktionierende Konstruktion oder abgearbeitete Bauanleitung genügt nicht. Die geprüften Modellblätter ersetzen keine reale Geräteerprobung.

## Produkt- und Reviewstand

Die Dokumentation setzt die UX01-Konzeptarbeit fort. UX01 und NA08 bleiben im Review, IMP08 offen. Die historische Re-Baseline-Gatefolge bleibt abgeschlossen. Die positive Rückmeldung zur Bedienbarkeit und die Kontextentscheidungen sind keine pauschale Produktabnahme.

Die im lokalen UX01-Bericht dokumentierten Eingabeverluste bleiben separat zu behandeln: phasenspezifische P2-Begründung sowie unbekannte S4-Aktion beim Speichern/Laden. Auch der Erhalt ausgewählter alter P3-Belege ist weiterhin eine eigene Vertragsentscheidung. Diese Dokumentationsänderung korrigiert keine Produktfunktion.

Der separate UX-Prototyp und seine synthetischen Sichtungsbelege liegen im Workspace; sie sind nicht Bestandteil dieser Repo-Lesefassung. Die hier enthaltenen fachlichen Planungsdokumente sind dagegen vollständig lesbar. Keine Hersteller-PDFs, Sichtungsbilder oder privaten Nutzungsdaten werden mit dieser Dokumentation veröffentlicht.

## Dokumentationspflege und Herkunft

Die fachlichen Originalnotizen heißen:
