...
- **Raw-Bibliografie.** Der exakte Belland-Titel lautet *Synthesizing Results From Empirical Research on Computer-Based Scaffolding in STEM Education: A Meta-Analysis*. Beim Signaling-Beitrag ist der Erstautor als Sascha Schneider zu führen; Titel und Reihenfolge lauten *A meta-analysis of how signaling affects learning with media*, Sascha Schneider, Maik Beege, Steve Nebel und Günter Daniel Rey. Die weiteren im Review festgestellten Namens- und Titelabweichungen lagen im Quellenregister und sind dort gegen DOI-/Publishermetadaten korrigiert.
...
**Befund.** In nicht randomisierten, pretest-adjustierten Treatment-Kontroll-Vergleichen lagen unmittelbare Posttest-Outcomes nach expliziten Selbstregulationstrainings im Mittel höher als in den Kontrollbedingungen; daraus folgt weder ein gesicherter kausaler Effekt noch eine universelle Trainingssequenz.
...
**Scope und Einschränkungen.** Klassen 1–6 beziehungsweise Lernende im Durchschnitt bis etwa 12 Jahre in realen Klassenräumen. Die Zuweisung zu Treatment und Kontrolle war nicht randomisiert; trotz Pretest-Adjustierung bleibt Restkonfundierung möglich. Nur vier Studien berichteten Follow-ups, für die keine Follow-up- oder Behaltens-Effektgrößen synthetisiert wurden; die Evidenz betrifft damit überwiegend unmittelbare Posttests. Computerbasierte Interventionen waren ausgeschlossen. Die Evidenz stammt von 2008; Programme, Messungen und Implementationen waren heterogen, die Zielgruppe überlappt nur teilweise mit Klasse 5–7, und weder ein digitales noch ein IuM-spezifisches Setting wurde untersucht. Die Mittelwerte garantieren keine einzelne Abfolge; Unterschiede zwischen forschungs- und lehrkraftgeleiteter Implementation begrenzen die Übertragung.
