...
| --- | --- | --- |
| BMB16-GYM-PK-SK-001 | Eigene Darstellung, Code, Spurbegründung und Systemgrenzen verlangen Kommunikation über informatische Modelle. | Curriculumabdeckung bleibt `unassessed`. |
| LH26-E-ALG-001 | Anweisungen werden grafisch und textuell als geordnete Folgen aufgebaut. | Reale Verständlichkeit offen. |
| LH26-E-ALG-002 | Ort und Blickrichtung bilden sichtbare Zustände. | Transferleistung nicht erprobt. |
| LH26-E-ALG-003 | Eigene Programme werden ausgeführt und schrittweise verfolgt. | Nutzungserfolg offen. |
| LH26-E-ALG-004 | Erste fachliche Abweichung, Vorher-/Nachher-Spur und Begründung stützen Revision. | Qualität der Lernendenbegründungen offen. |
| LH26-E-ALG-005 | Fünfteilige Wiederholung wird selbst als ausführbarer Code eingegeben. | Papierweg allein erfüllt das Ziel nicht. |
| LH26-E-ALG-006 | S4/S5 trennen Zustandsbedingungen, Zeitsteuerung, Wegberechnung und Aussagegrenzen. | Transfer im Unterricht offen. |
...
MAT-01 bis MAT-10 sind im geschlossenen Materialmanifest vorhanden, dem 225-Minuten-Entwurf zugeordnet und durch Materialvertrag sowie Ausspielung gebunden. MAT-01–04 tragen Einstieg, Legende, Beispiel und eigenen Entwurf; MAT-05–07 Revision, Rückkehr/Abruf und Transfer; MAT-08–10 Systeme, Hilfen und Sicherung. Die neunseitige A4-Fassung ist ein gleichwertiger Planungs- und Dokumentationsweg, ersetzt aber nicht die eigene digitale Codeeingabe nach ALG-005.
