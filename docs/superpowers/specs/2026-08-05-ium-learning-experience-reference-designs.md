...
| LXP03-06 | verbundene Lernenden- und Lehrkraftspur | LXP01 §§ 12, 18, 21–24; LXP02 Lehrkraft-/Sozialformvertrag | Lehrkraftspur je Referenzentwurf | Situationen 1–3 | Haltepunkte, Rollen, gewöhnliche Evidenz und Fallback | specified |
| LXP03-07 | gleichwertige Bedien- und Darstellungswege | LXP01 § 19; LXP02 A11Y-01 bis A11Y-12 | Accessibility je Referenzentwurf | Situationen 1–3 | Tastatur-, Touch-, Text-/AT-, Reduced-Motion- und Reflowpfad | specified |
| LXP03-08 | konkrete Local-First-, Offline- und Recoveryabläufe | LXP01 § 20; LXP02 RES-INFO/LIMIT/BLOCK | Resilienz je Referenzentwurf | Situationen 1–3 | erhaltener Stand, sichere Primärhandlung und Rückweg | specified |
...
## Vergleichende Qualitätsprüfung

### Urteilsskala

- `pass`: Der konkrete Entwurf erfüllt das LXP01-Gate mit benannter Evidenz; das Fail-Signal bleibt für LXP04/LXP06 als Regressionstest erhalten.
- `pass-with-explicit-risk`: Der Entwurf besitzt einen tragfähigen Mechanismus, aber die spätere System- oder Produktrealisierung muss ein konkret benanntes Darstellungsrisiko schließen.
- Ein blockierendes Urteil würde den gebündelten LXP03-Review verhindern. In der folgenden Matrix liegt keines vor.

### Qualitätsurteile Q1–Q8

| Situation | Qualitätsdimension | Urteil | konkrete Entwurfsevidenz | verbleibendes Risiko | Eigentümerphase | beobachtbares Fail-Signal |
|---|---|---|---|---|---|---|
| 1 | Q1 Lernhandlungs-Klarheit | pass | Startboard beantwortet Ziel, Produkt, Position, nächsten fachlichen Schritt und Rückweg; Primäraktion benennt das Ergebnis. | Copy kann im realen IUM5-Inhalt unpräzise werden. | LXP05 Inhalt; LXP06 Fach-/Usabilityreview | Testperson kann Ziel, aktuelles Produkt oder nächsten Schritt nicht in eigenen Worten benennen. |
| 1 | Q2 kognitive Ökonomie | pass-with-explicit-risk | stabile Fokusbühne zeigt eine unerledigte Sache; Kontextband und Normaltechnik bleiben nachrangig; Wide-/Schmalbudget ist definiert. | tatsächliche Typografie und Inhaltslängen können Leitfrage oder Aktion verdrängen. | LXP04 Kompositionsvertrag; LXP06 kognitiver Walkthrough | Leitfrage oder Primäraktion ist in schmaler/weiter Ansicht nicht ohne konkurrierende Kontrolle auffindbar. |
| 1 | Q3 Agency und Motivation | pass | Neu-, Lehrkraft-, Fortsetzungs- und Wiedereinstieg bieten begrenzte fachliche Entscheidungen ohne Punkte, Streak oder Rang. | Direktstart könnte in Copy als Zwang statt transparenter Unterrichtsrahmen erscheinen. | LXP04 Contentpattern; LXP05 Modulhandbuch | lokaler Stand wird überschrieben oder Motivation wird durch Belohnung, Personlob oder künstliche Knappheit erzeugt. |
| 1 | Q4 Feedback und Revision | pass | Startfeedback bestätigt Kontext und Stand, bewertet keine Person; Vorhersage bleibt notwendiger Vergleichsanker. | eine spätere Erfolgsmeldung könnte Startbereitschaft mit fachlicher Richtigkeit verwechseln. | LXP04 Statuspattern; LXP06 Contentreview | System meldet fachlichen Erfolg, bevor eine Wirkung beobachtet und gedeutet wurde. |
| 1 | Q5 Fortschritt und Kontinuität | pass | letzter sinnvoller Zustand, offene Handlung und aktiver Abruf ersetzen Prozent- oder Besuchsfortschritt. | Inhaltsmigration muss die fachliche Bedeutung des Fortsetzungspunkts erhalten. | LXP04 Recoverypattern; LXP05 Implementierung | Rückkehr verlangt Vollorientierung, verliert den offenen Schritt oder zeigt Klick-/Zeitfortschritt. |
| 1 | Q6 Lehrkraftorchestrierung | pass | gemeinsames Ziel, Rollen, Haltepunkt, gewöhnliche Evidenz und neutraler Fallback sind mit dem Lernendenpfad verbunden. | reale Zeitkorridore und Geräteverteilung sind noch nicht erprobt. | LXP05 Modulhandbuch; LXP06 Unterrichtswalkthrough | Lehrkraft kann die Phase nur mit Gerätedashboard, Fernsteuerung oder privatem Arbeitszugriff beginnen. |
| 1 | Q7 Accessibility und Gleichwertigkeit | pass-with-explicit-risk | Touch, Tastatur, Text-/AT, Fokus-Rückkehr, Reflow und Reduced Motion führen zur gleichen ersten Denkentscheidung. | visuelle Umsetzung kann Bedingung, Rückweg oder Fokusanker im schmalen Pfad verlieren. | LXP04 Accessibility-/Interaktionssystem; LXP06 WCAG/manuell | ein Pfad erhält weniger Kontext, andere Guards oder eine andere fachliche Handlung. |
| 1 | Q8 Resilienz, Datenschutz und Offenheit | pass | Offlinebereitschaft ist ehrlich nachrangig; Recovery erhält beide Stände; weder Konto noch Telemetrie sind erforderlich. | tatsächliche Assetabhängigkeiten bleiben technische Implementierungsfrage. | LXP05 Implementierung; LXP06 Offlineprüfung | nicht verfügbarer Start erscheint nutzbar, lokaler Stand wird verworfen oder ein Konto wird verlangt. |
| 2 | Q1 Lernhandlungs-Klarheit | pass | sechs Lernzustände trennen Vorhersage, Handlung, Beobachtung, Interpretation, Revision und Sicherung mit konkreten Verben. | Zustandslabels allein dürfen nicht zur Prozessbürokratie werden. | LXP04 Content-/Statepattern; LXP06 Walkthrough | Lernende können nicht sagen, was gerade geprüft wird und warum die nächste Handlung folgt. |
| 2 | Q2 kognitive Ökonomie | pass-with-explicit-risk | vier konkrete Zustandskompositionen koppeln Algorithmus, Szene, Laufspur, Erwartung und Feedback nur nach Bedarf. | Wide-Ansicht kann Split-Attention, schmale Ansicht Erinnerungsarbeit erzeugen. | LXP04 Kompositionssystem; LXP06 kognitiver Walkthrough | Handlung, Wirkung und Rückmeldung sind nicht gleichzeitig zusammenhängend verständlich. |
| 2 | Q3 Agency und Motivation | pass | Vorhersage, Belegwahl, Hypothese, Hilfenwahl und Revision sind echte begrenzte Entscheidungen; der grüne Lauf ist kein Lernstatus. | Hilfen können in konkreter Copy zu stark lenken. | LXP05 Inhaltsproduktion; LXP06 Aufgabenreview | Lösung wird vor der eigenen Entscheidung sichtbar oder Versuchszahl/Punkte gelten als Fortschritt. |
| 2 | Q4 Feedback und Revision | pass | Feedback lokalisiert Ergebnis und erste Abweichung; Revision braucht Beleg, Änderung und neue Vorhersage. | fachliche Korrektheit hängt am konkreten Interpreter-/Szenariovertrag. | LXP05 Fachlogik; LXP06 Fachtest | Rückmeldung bleibt bei richtig/falsch, verrät die Lösung oder eine Revision überspringt den Beleg. |
| 2 | Q5 Fortschritt und Kontinuität | pass | Ausgangs- und Revisionsfassung, ausgewählter Beleg und bestätigter Rückkehrzustand bilden fachlichen Produktfortschritt. | viele Revisionen könnten später doch zur Versuchschronik anwachsen. | LXP04 Persistenzpattern; LXP05 Datenmodell | Fortschritt beruht auf Läufen, Zeit oder Klicks statt belegter Produktänderung. |
| 2 | Q6 Lehrkraftorchestrierung | pass | wechselnde 1:2-Rollen, neutraler Fehlerfall, 5–10-Minuten-Halt und sichere Rückkehr benötigen keine Systemüberwachung. | Rollenbalance und Haltepunktdauer sind noch nicht im Unterricht validiert. | LXP05 Modulhandbuch; LXP06 Unterrichtswalkthrough | eine Person bleibt Zuschauer oder die Lehrkraft braucht Fehlerranking/Livefeed. |
| 2 | Q7 Accessibility und Gleichwertigkeit | pass-with-explicit-risk | gemeinsame semantische Quelle erzeugt Szene, Schritttext, Zustandsansage und Beleg; Drag-and-drop/Animation sind nie exklusiv. | AT- oder Reduced-Motion-Pfad könnte versehentlich Lösung oder anderen Beleg erzeugen. | LXP04 Accessibility-/Feedbacksystem; LXP06 WCAG/manuell | alternativer Pfad überspringt Vorhersage/Revision, verrät Lösung oder erzeugt nicht denselben Beleg. |
| 2 | Q8 Resilienz, Datenschutz und Offenheit | pass-with-explicit-risk | RES-INFO/LIMIT/BLOCK benennt verfügbare Handlung, autoritativen Stand und sicheren Rückweg; Kern soll vollständig lokal sein. | reale Interpreter-, Asset- und Speicherabhängigkeiten sind noch nicht implementiert. | LXP04 Resilienzpattern; LXP05 Implementierung; LXP06 Offlineprüfung | Offlinezustand bietet tote Aktion, verliert Revision oder erklärt ungleichwertigen Fallback für gleichwertig. |
| 3 | Q1 Lernhandlungs-Klarheit | pass | Beleg auswählen, Karte sichern, übertragen, exportieren, pausieren und später abrufen besitzen getrennte Zielzustände. | eine spätere globale `weiter`-Aktion könnte die Trennung verwischen. | LXP04 Navigations-/Contentpattern; LXP06 Walkthrough | Lernende können Sicherung, Transfer, Export und Ausstieg nicht unterscheiden. |
| 3 | Q2 kognitive Ökonomie | pass-with-explicit-risk | Karte referenziert reale Spuren statt Vollchronik; Quelle und Beleg stehen vor Aussage, Transfer und Abruf sind getrennte Zustände. | Umsetzung könnte Karte, Transfer, Export und Anschluss auf eine Abschlussseite stapeln. | LXP04 Kompositionssystem; LXP06 kognitiver Walkthrough | Doppelverschriftlichung oder gleichzeitige Primärfunktionen verdrängen die fachliche Aussage. |
| 3 | Q3 Agency und Motivation | pass | Belegwahl, Aussage, Modellgrenze, Transferurteil, freiwilliger Export und nicht erzwungener Anschluss bleiben bei Lernenden. | freiwilliges Teilen könnte sozial als Pflicht gerahmt werden. | LXP05 Modulhandbuch; LXP06 Unterrichtswalkthrough | Offenlegung wird erwartet, Export erzwungen oder Abschluss durch Badge/Belohnung ersetzt. |
| 3 | Q4 Feedback und Revision | pass | Karte verbindet Ausgang, Beleg, Interpretation und Revision; heutige Abrufantwort bleibt getrennt und vergleichbar. | Satzstarter können eine Scheinkohärenz erzeugen. | LXP05 Inhalt; LXP06 Fach-/Aufgabenreview | Karte enthält glatte Aussage ohne Belegbezug oder alte/neue Fassung wird still verschmolzen. |
| 3 | Q5 Fortschritt und Kontinuität | pass | gesicherte Karte, Transferantwort, nächster Abruf und Versionshinweis bilden anschlussfähigen lokalen Stand. | späterer Abrufpunkt muss im realen Modulrhythmus tatsächlich gesetzt werden. | LXP05 Modulhandbuch; LXP06 längerer Walkthrough | alte Karte wird sofort gezeigt, Abruf entfällt oder Rückkehr erzeugt keinen neuen Anschluss. |
| 3 | Q6 Lehrkraftorchestrierung | pass | freiwilliger/neutraler Beleg, gemeinsame Kernaussage/Modellgrenze und Diagnose-Fallback ermöglichen Sicherung ohne Sammlung. | Beobachtungsqualität hängt von vorbereiteten Rückfragen ab. | LXP05 Modulhandbuch; LXP06 Unterrichtswalkthrough | alle Karten müssen eingesammelt/projiziert werden oder neutrale Evidenz fehlt. |
| 3 | Q7 Accessibility und Gleichwertigkeit | pass-with-explicit-risk | Wide-/Schmalfolge, Text-/AT-Felder, Fokus nach Abruf/Export, Reduced Motion und sichere Dialogrückkehr sind explizit. | Quellenrelation kann bei Reflow oder assistiver Ausgabe fragmentieren. | LXP04 Accessibility-/Kartenpattern; LXP06 WCAG/manuell | schmaler/assistiver Pfad verliert Quellkontext, Kartenfeld, Exportfolge oder Transfergleichwertigkeit. |
| 3 | Q8 Resilienz, Datenschutz und Offenheit | pass | Karte bleibt lokal; Export erklärt Eigentum/Sensitivität; Löschung und inkompatible Version erhalten das Original atomar. | Dateiformat, Lizenzmetadaten und Migration müssen später technisch bewiesen werden. | LXP04 Datenpattern; LXP05 Implementierung; LXP06 Offline-/Importtest | Export teilt automatisch, Löschung ist unklar oder eine Teilmigration überschreibt das Original. |

**Bilanz:** 24/24 konkrete Urteile, davon 17 `pass`, 7 `pass-with-explicit-risk`, kein blockierendes Urteil. Jede Zeile besitzt Entwurfsevidenz, Restrisiko, Eigentümerphase und beobachtbares Fail-Signal.

### Antworten auf die sieben LXP02-Darstellungsrisiken

| Risiko-ID | geerbtes Risiko | konkrete LXP03-Antwort | Restunsicherheit | Eigentümerphase | Fail-Signal |
|---|---|---|---|---|---|
| RISK-LXP02-S1-Q2 | Einstieg: kognitive Ökonomie | eine Fokusbühne, höchstens eine unerledigte Sache, nachrangiges Kontextband und konkrete Wide-/Schmalbudgets | reale Textlänge/Typografie ungeprüft | LXP04, danach LXP06 | Leitfrage oder Startaktion konkurriert mit Navigation, Technik oder Gesamtkarte. |
| RISK-LXP02-S1-Q7 | Einstieg: Accessibility/Gleichwertigkeit | identische Neu-/Fortsetzungs-/Direktstartentscheidung über Touch, Tastatur und Text-/AT; Fokus- und Recoveryrückkehr definiert | reale Semantik/Zoom ungeprüft | LXP04, danach LXP06 | alternativer Pfad verliert Bedingung, Rückweg oder erzeugt einen anderen Stand. |
| RISK-LXP02-S2-Q2 | Kernhandlung: Ursache–Wirkung | vier Kompositionen halten Erwartung, Befehl, Vor-/Nachzustand, Laufspur und Feedback je Zustand verbunden | visuelle Dichte ungeprüft | LXP04, danach LXP06 | Lernende müssen Ursache oder Wirkung aus verborgener vorheriger Ansicht erinnern. |
| RISK-LXP02-S2-Q7 | Kernhandlung: gleichwertige Interaktion | eine semantische Quelle, schrittweise Ausführung, beschriftete Alternativen, Text-/AT-Laufspur und Reduced Motion | konkrete Widget- und Screenreaderwahl offen | LXP04, danach LXP06 | Drag, Farbe, Position oder Animation wird exklusiv oder verrät im Alternativpfad die Lösung. |
| RISK-LXP02-S2-Q8 | Kernhandlung: Offlinewahrheit | lokale Kernhandlung; RES-LIMIT nur bei gleichwertigem Kern, RES-BLOCK bei fehlendem Interpreter/Integritätsrisiko | Asset- und Cachearchitektur offen | LXP04/LXP05, danach LXP06 | tote Aktion, Datenverlust oder falsch behauptete Gleichwertigkeit im Offlinefall. |
| RISK-LXP02-S3-Q2 | Sicherung: kognitive Ökonomie | Belegkarte referenziert echte Spuren; Auswahl, Schreiben, Transfer, Export und Abruf sind getrennte Zustände | endgültige Kartendichte offen | LXP04, danach LXP06 | Vollchronik, Zweittext oder mehrere gleichgewichtige Abschlussaktionen dominieren. |
| RISK-LXP02-S3-Q7 | Sicherung: Accessibility/Gleichwertigkeit | Quelle vor Editieren, vollständige Schrittgruppen im Reflow, programmatische Feldbezüge, Fokusvertrag für Abruf/Export/Recovery | reales PDF-/Exportformat offen | LXP04/LXP05, danach LXP06 | Quellenbezug, Sensitivität, sichere Abbruchfolge oder Transferentscheidung fehlt in einem Pfad. |

### Globaler Anti-Pattern-Scan

| AP-ID | LXP01-Anti-Pattern | Entwurfsprüfung | Ergebnis / Regression-Signal |
|---|---|---|---|
| AP-01 | Mega-Seite | Fokusbühne und Zustandskomposition trennen Einstieg, Loop und Sicherung; Kontext ist bedarfsgerecht. | ausgeschlossen; Regression bei gleichzeitig primären Phasen, Werkzeugen, Hilfen und Datenhandlungen |
| AP-02 | Infrastruktur-First | Offline-/Speicherstatus bleibt RES-INFO, solange keine Handlung betroffen ist. | ausgeschlossen; Regression, wenn Technik vor Leitfrage/Primäraktion dominiert |
| AP-03 | Pseudo-Fortschritt | sichtbar sind fachlicher Zustand, Produktänderung, Beleg und Wiedervorlage, keine Prozentzahl. | ausgeschlossen; Regression bei Seiten-, Klick- oder Zeitfortschritt |
| AP-04 | dekorative Gamification | kein Punkt, Badge, Streak, Rang, Timer oder Konfetti trägt Motivation. | ausgeschlossen; Regression bei Belohnung statt Produktverbesserung |
| AP-05 | offene Wahl ohne Struktur | Wahl ist begrenzt durch Ziel, Kriterium, Voraussetzung und aktuellen Lernzustand. | ausgeschlossen; Regression bei gleichgewichtigen Start-/Folgeoptionen ohne Konsequenzklärung |
| AP-06 | Wizard ohne Überblick | Gesamtkarte bleibt orientierend erreichbar; Rückkehranker und Zustandsbeziehung sind sichtbar. | ausgeschlossen; Regression bei irreversibler Schrittfolge ohne Kontext/Rückkehr |
| AP-07 | Feedback als Urteil | Rückmeldung nennt Ergebnis, Stelle, Beleg und nächsten Prüfschritt. | ausgeschlossen; Regression bei richtig/falsch, Ampel oder Lob ohne Fachinformation |
| AP-08 | adaptive Blackbox | Hilfen werden bewusst gewählt; Klicks, Zeit, Fehler- und Hilfenutzung werden nicht profiliert. | ausgeschlossen; Regression bei automatischer Pfad-/Hilfenpersonalisierung aus Verhaltensdaten |
| AP-09 | Lehrkraft als Nachtrag | jede Situation enthält sichtbaren Haltepunkt, Rollen, Evidenz, Intervention und Fallback. | ausgeschlossen; Regression, wenn Unterricht nur durch externes Handbuch koordinierbar ist |
| AP-10 | Accessibility als Parallelprodukt | dieselbe semantische Quelle, Guards, Entscheidungen, Belege und Rückmeldungen gelten für alle Pfade. | ausgeschlossen; Regression bei vereinfachter oder lösungsoffenlegender Alternativaufgabe |
| AP-11 | Narration als Lernersatz | Fallkontext führt stets zu Vorhersage, Modellhandlung, Beleg, Revision oder Urteil. | ausgeschlossen; Regression, wenn Mission/Animation ohne Denkprodukt genügt |
| AP-12 | Export als Abschluss | Belegkarte sichern, Transfer, Export, Pause und Ausstieg sind getrennte Handlungen; Export ist optional. | ausgeschlossen; Regression, wenn Dateierzeugung als Sicherung/Lernnachweis gilt |

### Widerspruchs- und Konsistenzledger

| Widerspruch | gewählte Priorität | konkrete Auflösung in den Entwürfen | bewusster Preis | erneuter Gatepunkt |
|---|---|---|---|---|
| Überblick versus Fokus | fachlicher Fokus bei rekonstruierbarem Überblick | Kontextband plus erreichbare Gesamtkarte; kein paralleler Vollnavigator | ein bewusster Öffnungs-/Rückkehrschritt | LXP04 Kompositionssystem |
| Lehrkraftsteuerung versus lokale Agency | transparenter gemeinsamer Rahmen und lokale Bestätigung | Direktstart benennt Herkunft; abweichender Stand wird geparkt | freie Pfadwahl ist in gemeinsamer Phase begrenzt | LXP05 Modulhandbuch/LXP06 Walkthrough |
| visuelle Dynamik versus gleichwertige Information | semantische Schrittfolge vor Animation | Schritttext, Vor-/Nachzustand und Statusmeldung sind normativ; Bewegung optional | weniger spektakuläre Inszenierung | LXP04 Motion-/Accessibilityvertrag |
| progressive Offenlegung versus Quellenbezug | nur aktuelle Funktion primär, erforderliche Beziehung bleibt sichtbar | Beleg/Quelle bleibt vor Editieren und über Rücksprung erreichbar | teilweise zusätzlicher Navigationsschritt | LXP04 Reflow-/Kartenpattern |
| ununterbrochener Flow versus Offlinewahrheit | fachliche und Datenintegrität vor Scheinkontinuität | RES-BLOCK pausiert nur bei Kern-/Integritätsrisiko; Original/Stand bleibt | reale Unterbrechung möglich | LXP05 technische Umsetzung/LXP06 Offlineprüfung |
| späterer Anschluss versus Datenminimierung | ausgewählte Produkt-/Belegspuren statt Verhaltenshistorie | Karte, Transferantwort und Abrufpunkt lokal; keine Zeiten/Versuche/Hilfenutzung | weniger retrospektive Prozessdaten | LXP04 Datenvertrag |
| Lehrkraft-Awareness versus Datenschutz | gewöhnliche Evidenz und neutrale Fälle vor Monitoring | Gespräch, Handzeichen, freiwilliger Beleg und neutraler Fallback | höhere Beobachtungsverantwortung | LXP05 Modulhandbuch/LXP06 Unterrichtswalkthrough |
