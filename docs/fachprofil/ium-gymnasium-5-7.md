...
| Forschungsbefund oder inferentielle Forschungsfolge | **Forschungsregel** oder **Forschungsfolge · `working`** | zitiert nahe am Satz registrierte `CLAIM-*`-IDs; die Übertragung auf IuM 5–7 bleibt dort vorsichtig, wo der Claim sie begrenzt |
...
**Projektentscheidung:** Die Zusatzkennzeichnung `No-Go` bezeichnet ausschließlich die Prüffunktion eines Ausschlusskriteriums; der Herkunftstyp bleibt `Projektentscheidung`. ([Gesamtdesign, Abschnitte 3 und 13](../superpowers/specs/2026-07-27-ium-lernwerk-gesamtdesign.md))
...
- **Artefaktstatus:** Die [15 Designprinzipien](../research/phase-0/design-principles.json) beruhen auf registrierten Claims. Ihre Status bleiben unverändert: zwölf `working`, drei `reviewed`, kein `draft` und kein `standard`.
...
**Projektentscheidung · `working`:** Der Fachkern besteht aus zwei eigenständigen, aufeinander beziehbaren Strängen. Informatik untersucht und gestaltet Daten, Algorithmen und digitale Systeme. Medienbildung untersucht und gestaltet mediale Kommunikation, Repräsentationen, Interessen, Wirkungen und gesellschaftliche Handlungsmöglichkeiten. ([Gesamtdesign, Abschnitte 3 und 5](../superpowers/specs/2026-07-27-ium-lernwerk-gesamtdesign.md))

### Gemeinsame Denkweisen

- **Curriculumregel:** Modellieren, implementieren, strukturieren, analysieren, vergleichen, testen, bewerten, kommunizieren und kooperieren sind in den geltenden Plänen ausgewiesene fachliche Handlungen. [SRC-CUR-BMB-2016; SRC-CUR-INF7-2016]
- **Projektentscheidung:** Der Abdeckungsnachweis macht die jeweils einschlägigen fachlichen Handlungen sichtbar; reine Themenzuordnung genügt nicht. ([Gesamtdesign, Abschnitt 3](../superpowers/specs/2026-07-27-ium-lernwerk-gesamtdesign.md))
- **Forschungsfolge · `working`:** Jede Aktivität weist Ziel, fachliche Denkhandlung, Unterstützung, Rückmeldung und Sicherung aus; Medium oder Methode allein sind kein Qualitätsnachweis. [CLAIM-LP-001; CLAIM-DLE-014]
- **Forschungsfolge · `working`:** Modelle werden konstruiert, auf Fälle angewandt, mit beobachtbarem Verhalten oder Realität verglichen und an ihren Grenzen geprüft. [CLAIM-INF-005; CLAIM-INF-010]
...
- **Forschungsfolge · `working`:** Tracing, Syntaxarbeit, Musterverständnis, Testen, Debugging und Eigenkonstruktion werden als unterscheidbare Praktiken geplant. [CLAIM-INF-003; CLAIM-INF-007]
- **Forschungsfolge · `working`:** Repräsentationen verbinden Daten oder Code, Ausführung, Zustand und Ausgabe; Lernende bearbeiten sie durch Vorhersage, Ergänzung, Erklärung, Vergleich oder Korrektur. [CLAIM-INF-004; CLAIM-INF-005]
- **Projektentscheidung · No-Go:** Softwarebedienung ist Mittel für eine informatische Handlung, nicht dauerhafter Fachkern. ([Gesamtdesign, Abschnitt 5.1](../superpowers/specs/2026-07-27-ium-lernwerk-gesamtdesign.md))
...
- **Forschungsfolge · `working`:** Medienbildungsaufgaben verlangen aktive Analyse, Belegprüfung, Produktion oder Revision; kleine mittlere Interventionseffekte begründen weder eine feste Sequenz noch die Überlegenheit eines Mediums. [CLAIM-MED-002]
- **Forschungsfolge · `working`:** Privatsphäre, Empfehlung und Werbung werden über Datenarten, Akteure, Interessen und Gestaltungsmechanismen erschlossen. Die konkrete Auswahl und Verbindung dieser Perspektiven ist in IuM 5–7 zu pilotieren. [CLAIM-MED-001; CLAIM-MED-005; CLAIM-MED-006]
- **Forschungsfolge · `working`:** Desinformation und KI-Ausgaben werden wiederholt als prüfbare Behauptungen bearbeitet; ein KI- oder Detektorlabel ist kein Endurteil. Wiederholungsform, Aufgabenfolge und Altersübertragung sind in IuM 5–7 zu pilotieren. [CLAIM-MED-003; CLAIM-MED-004]
- **Projektentscheidung · No-Go:** Warnbotschaften, Risikoaufzählungen und bloße Anwendungsfertigkeiten ersetzen weder Mechanismuserklärung noch begründetes Urteil. ([Gesamtdesign, Abschnitte 5.2 und 5.4](../superpowers/specs/2026-07-27-ium-lernwerk-gesamtdesign.md))
...
- **Forschungsfolge · `working`:** Technische, ökonomische, gestalterische und gesellschaftliche Beziehungen werden nur so weit verbunden, wie sie die konkrete fachliche Frage tragen. [CLAIM-MED-001; CLAIM-MED-005; CLAIM-MED-006]
...
- **Projektentscheidung · No-Go:** Ein gemeinsames digitales Werkzeug, ein Lebensweltbezug oder das Wort „Digitalität“ ist noch keine fachliche Integration. ([Gesamtdesign, Abschnitt 5.4](../superpowers/specs/2026-07-27-ium-lernwerk-gesamtdesign.md))
...
- **Forschungsfolge · `working`:** Klasse 5 erhält bei Exploration ein eigenes Überforderungsgate; begrenzte Exploration muss in explizite Erklärung und Sicherung münden. Ausgestaltung und Altersübertragung dieses Gates sind in IuM 5–7 zu pilotieren. [CLAIM-LP-012]
- **Forschungsregel:** Block- und Textdarstellungen besitzen keinen evidenzbasierten festen Alterswechsel. [CLAIM-INF-008]
- **Forschungsfolge · `working`:** Lernziel, Syntaxlast und Anschlussweg leiten die vorläufige Darstellungsentscheidung. [CLAIM-INF-008]
- **Forschungsfolge · `working`:** Spätere Module greifen Kernkonzepte mit Abstand und veränderter fachlicher Handlung wieder auf; Wiedersehen allein ist kein aktiver Abruf oder Transfer. [CLAIM-LP-007; CLAIM-LP-008; CLAIM-LP-009]
...
- **Forschungsfolge · `working`:** Material wird danach ausgewählt, welche fachliche Denkhandlung es ermöglicht; zusätzliche Such-, Bedien- und Darstellungsbelastung wird begrenzt. [CLAIM-LP-001; CLAIM-LP-003]
- **Forschungsfolge · `working`:** Zusammengehörige Informationen stehen räumlich oder zeitlich zusammen; wechselnde Darstellungen verwenden konsistente Bezeichner und sichtbare Zuordnungen. [CLAIM-LP-003]
- **Forschungsfolge · `working`:** Worked Examples sind Aufgabenmaterial: Lernende sagen voraus, ergänzen, erklären, vergleichen, testen oder korrigieren sie. [CLAIM-INF-004; CLAIM-LP-004; CLAIM-LP-005]
- **Forschungsfolge · `working`:** Informatische Ausführungsdarstellungen zeigen mindestens relevante Eingabe, Ausführungsposition, Zustand und Ausgabe; jede Darstellung nennt ihren Zweck und ihre Modellgrenze. [CLAIM-INF-005]
...
**Forschungsfolge · `working`:** Jede Programmiersequenz weist aus, welche der folgenden Praktiken tatsächlich gelernt und geprüft wird. Die Praktiken operationalisieren die curricularen Handlungen und die Befunde zu PRIMM, getrennten Programmierpraktiken und Debugging. Ihre konkrete Kombination und Dosierung ist in IuM 5–7 zu pilotieren. [CLAIM-INF-002; CLAIM-INF-003; CLAIM-INF-007]
...
- **Forschungsfolge · `working`:** Predict–Run–Investigate–Modify–Make ist ein geeigneter zu erprobender Zyklus, aber kein Beleg dafür, dass jede Phase isoliert wirkt oder immer dieselbe Reihenfolge braucht. [CLAIM-INF-002]
- **Forschungsfolge · `working`:** Debugging wird als Problemlösen mit Hypothese und Test angelegt, nicht bloß als Beseitigen einer Fehlermeldung. [CLAIM-INF-007]
- **Forschungsfolge · `working`:** Block-/Textübergänge nutzen isomorphe Beispiele, Übersetzungsaufgaben oder strukturierte Editoren; sie werden nicht allein an ein Alter gebunden. [CLAIM-INF-008]
...
- **Forschungsfolge · `working`:** Der wiederkehrende Analysezyklus umfasst Mechanismus, Akteur, Interesse, Beleg, Gegenbeleg, Unsicherheit und Revision. Zusammensetzung, Reihenfolge und Wiederholung dieses Zyklus sind in IuM 5–7 zu pilotieren. [CLAIM-MED-001; CLAIM-MED-003; CLAIM-MED-004; CLAIM-MED-005; CLAIM-MED-006]
...
- **Forschungsfolge · `working`:** Aussagen über Wirkungen unterscheiden Beobachtung, Korrelation, mögliche Erklärung und individuelle Unsicherheit; aus Gruppenbefunden entsteht keine Individualdiagnose. [CLAIM-MED-008; CLAIM-MED-010]
...
- **Forschungsfolge · `working`:** Produktion ist eine aktive Medienbildungsleistung, wenn Gestaltungsentscheidungen erklärt und aufgrund von Kriterien oder Feedback revidiert werden. [CLAIM-MED-002; CLAIM-LP-010]
- **Forschungsfolge · `working`:** Offene Produktion dokumentiert Titel, Urheber, Quelle, Lizenz, Lizenzlink, Änderungen und eigene Anteile. [CLAIM-MED-013; CLAIM-DLE-010; CLAIM-DLE-011]

## 11. Typische Vorstellungen, Fehlvorstellungen und Lernbarrieren

**Forschungsregel:** Vorstellungen werden als prüfbare aktuelle Deutungen behandelt, nicht als feste Eigenschaften von Personen. [CLAIM-LP-002; CLAIM-INF-006]

**Forschungsfolge · `working`:** Die folgende Planungsfolge ist eine inferentielle Anwendung:
...
- **Forschungsregel:** Eine einzelne falsche Antwort belegt kein stabiles Fehlkonzept. [CLAIM-LP-002; CLAIM-INF-006]
- **Forschungsfolge · `working`:** Vorwissen und Vorstellungen werden lokal, aufgabenbezogen und revidierbar sichtbar gemacht. [CLAIM-LP-002; CLAIM-INF-006]
...
- **Forschungsfolge · `working`:** Hilfen benennen die konkrete Hürde und erhalten die zentrale Denkhandlung; Rücknahme folgt sichtbarer fachlicher Bewältigung, nicht Zeit, Klickzahl oder Telemetrie. [CLAIM-LP-006]
- **Forschungsfolge · `working`:** Beispiele und Hilfen können vom vollständigen Beispiel über Lücken und Modifikation zur Eigenkonstruktion führen; die konkrete Dosierung für 10- bis 13-Jährige bleibt zu pilotieren. [CLAIM-INF-004; CLAIM-LP-004]
- **Forschungsfolge · `working`:** Wenige fachlich fokussierte Selbsterklärungsprompts dienen Beziehungen, Vorhersagen, Begründungen oder Reparaturen; generische Warum-Fragen sind kein Standard. [CLAIM-LP-005]
- **Forschungsfolge · `working`:** Aktiver Abruf, verteilte Wiederaufnahme und Transfer werden als getrennte Lernfunktionen geplant. [CLAIM-LP-007; CLAIM-LP-008; CLAIM-LP-009]
- **Forschungsfolge · `working`:** Feedback liefert nutzbare Information zum Produkt, zur Strategie oder zum nächsten Prüfschritt; Punkte, Lob oder sofortige Lösung ersetzen diese Funktion nicht. [CLAIM-LP-010]
- **Forschungsfolge · `working`:** Begrenzte Exploration erzeugt Vorläuferwissen und wird durch Vergleich, explizite Erklärung, Übung und gemeinsame Sicherung konsolidiert. Konkrete Sequenz, Dosierung und Altersübertragung sind in IuM 5–7 zu pilotieren. [CLAIM-LP-012]
...
- **Forschungsfolge · `working`:** Die Lehrkraft orchestriert kognitive Aktivierung, konstruktive Unterstützung und klare Führung; Methode, Sozialform und digitales Medium sind Sichtstruktur, nicht der Lernnachweis. [CLAIM-LP-001]
- **Forschungsfolge · `working`:** Sie verbindet Explorationsergebnisse mit expliziter Erklärung, insbesondere in Klasse 5, und lässt Fehlwege nicht fachlich ungeklärt stehen. [CLAIM-LP-012]
- **Forschungsfolge · `working`:** Sie entscheidet anhand sichtbarer Produkte und Gespräche über Hilfen und Fading; ein System inferiert keine Lernstrategie aus Nutzungsdaten. [CLAIM-LP-006; CLAIM-LP-013]
- **Forschungsfolge · `working`:** Bei sensiblen Themen trennt sie fachliche Fallanalyse von persönlicher Betroffenheit und hält schulische Hilfs- und Eskalationswege bereit. [CLAIM-MED-007; CLAIM-MED-009]
...
- **Forschungsfolge · `working`:** Digital ist fachlich begründet, wenn veränderliche Zustände, tatsächliche Programmausführung, unmittelbare Testfälle, Simulation, Quellenöffnung, Variantenvergleich, Produktion oder Revision die Lernhandlung tragen. [CLAIM-INF-005; CLAIM-LP-003]
- **Forschungsfolge · `working`:** Analog ist begründet, wenn räumliche Anordnung, freies Skizzieren, haptische Manipulation, Verkörperung, gemeinsame Modellierung oder bildschirmfreie Diskussion die fachliche Beziehung klarer oder störungsärmer macht. [CLAIM-LP-003; CLAIM-INF-009]
- **Forschungsfolge · `working`:** Unplugged-Material nennt fachliche Zuordnung, Modell- oder Analogiegrenze und eine formale oder digitale Anschlussaufgabe; sein Einsatz belegt keinen pauschalen Transfer. [CLAIM-INF-009]
...
- **Projektentscheidung · No-Go:** Kein Printmaterial ohne eigenständige Lernfunktion und dokumentierte Rückbindung; keine funktionslose Digitalisierung eines analogen Blatts. ([Gesamtdesign, Abschnitte 2.1 und 10.2](../superpowers/specs/2026-07-27-ium-lernwerk-gesamtdesign.md))

## 15. Nicht personenbezogene Diagnosegelegenheiten

**Forschungsfolge · `working`:** Diagnose bedeutet hier eine aktuelle, aufgabenbezogene Gelegenheit für Anschlussreaktion und Feedback, keine Erhebung eines stabilen Personenmerkmals. [CLAIM-LP-002; CLAIM-LP-010]
...
- **Forschungsfolge · `working`:** Geeignet sind Vorhersage, Trace, Modellskizze, Kontrastfall, Reparatur, Quellencheck, Testfall, Kriterienanwendung und begründete Revision. [CLAIM-INF-005; CLAIM-INF-006; CLAIM-INF-007; CLAIM-INF-010; CLAIM-MED-003; CLAIM-LP-010]
- **Forschungsfolge · `working`:** Einzelantworten werden nicht zu Fehlvorstellungs-, Selbstregulations-, psychischen oder spielbezogenen Profilen verdichtet. [CLAIM-LP-002; CLAIM-LP-013; CLAIM-MED-008; CLAIM-MED-010]
...
- **Forschungsfolge · `working`:** Jedes Asset dokumentiert Titel, Urheber, Fundstelle, Lizenzversion und -link, Änderungen, Drittmaterial und eine versions- und richtungsspezifische Kompatibilitätsentscheidung. [CLAIM-MED-013; CLAIM-DLE-010; CLAIM-DLE-011]
- **Forschungsfolge · `working`:** WCAG 2.2 AA ist das vollständige technische Baseline-Gate; Tastatur-, Touch- und Assistive-Technology-Pfade sowie reale Nutzeraufgaben prüfen zusätzlich gleichwertige Bedienbarkeit, nicht Lernwirksamkeit. [CLAIM-DLE-001; CLAIM-DLE-002; CLAIM-DLE-003]
- **Forschungsfolge · `working`:** Installation, Offlinekorrektheit, Cache, Lernstandsmigration, Wiederanbindung und reale schulische Browser-/MDM-Konfigurationen werden getrennt und datiert geprüft. [CLAIM-DLE-007; CLAIM-DLE-008; CLAIM-DLE-012; CLAIM-DLE-013]
...
- **Quellenstatus · Stand der Primärprüfung 28. Juli 2026:** Für die registrierten amtlichen Inhalte ist keine offene Lizenz ausgewiesen. ([Quellenstatus](../../curriculum/source-status.md))
- **Projektentscheidung:** Amtliche Inhalte ohne ausgewiesene offene Lizenz werden nicht stillschweigend als OER vervielfältigt; ihre Kompetenzanker werden über registrierte Quellen-IDs und quellentreue Datensätze nachgewiesen. ([Gesamtdesign, Abschnitte 2.5, 3 und 13](../superpowers/specs/2026-07-27-ium-lernwerk-gesamtdesign.md))
...
- **Forschungsfolge · `working`:** Beurteilbar sind aktuelle Produkte, Erklärungen, Testfälle, Strategien und dokumentierte Revisionen, nicht aus Telemetrie inferierte Personenmerkmale. [CLAIM-INF-006; CLAIM-LP-010; CLAIM-LP-013; CLAIM-MED-007]
...
### Quellen- und Geltungsstatus

- **Quellenstatus · Stand der Primärprüfung 28. Juli 2026:** Aus `SRC-CUR-LESEHILFE-2026-27`, `SRC-CUR-KM-FACHSEITE` oder `SRC-CUR-KM-FAQ-REFORM` keine curriculare Norm ableiten; die Lesehilfe ist Orientierung, die KM-Seiten sind administrativer Kontext. ([Quellenstatus](../../curriculum/source-status.md))

### Forschungsfolgen · `working`

- **Forschungsfolge · `working`:** Softwarebedienung, Geräteverfügbarkeit, Interaktivität oder ein Methodenlabel nicht als Lernqualität ausgeben. [CLAIM-LP-001; CLAIM-DLE-014]
- **Forschungsfolge · `working`:** Programmieraufgaben nicht auf „Code läuft“ oder reine Eigenkonstruktion ohne Lesen, Erklären, Testen und Debugging reduzieren. [CLAIM-INF-003; CLAIM-INF-007]
- **Forschungsfolge · `working`:** Medienanalyse nicht auf Warnung, Meinung, Checkliste oder Detektor-Endurteil verkürzen. [CLAIM-MED-002; CLAIM-MED-003; CLAIM-MED-004]
- **Forschungsfolge · `working`:** Keine persönliche Offenlegung, Peerdiagnostik, Rankings, Risiko- oder Kompetenzprofile und zentrale sensible Fallspeicherung verlangen. [CLAIM-MED-007; CLAIM-MED-008; CLAIM-MED-010]
- **Forschungsfolge · `working`:** Kein offenes Entdecken ohne erreichbares Zielwissen, Unterstützung, explizite Konsolidierung und Sicherung einsetzen. [CLAIM-LP-012]
